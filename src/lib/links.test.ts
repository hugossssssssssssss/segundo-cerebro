...
describe("propagarRenomeacao", () => {
  ...
  it("propaga renomeação de IDs estruturais em metas, pai_id e processo_id", async () => {
    ...
    const r1 = await propagarRenomeacaoId(cfg, acervoLocal, "meta-antiga", "meta-nova");
    expect(r1.atualizados).toBe(1);
    expect(gravados["pdi/entregas/entrega1.md"]).toContain("meta-nova");
